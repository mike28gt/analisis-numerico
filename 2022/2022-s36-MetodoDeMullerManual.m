...
%% ¿Qué valor es mayor, abs(sol_1) o abs(sol_2)?
  sol_1 = abs(b + discriminante)
  sol_2 = abs(b - discriminante)

%% Determinar la nueva aproximacion de la raíz
  x_3 = x_2 + ((-2 * c) / (b + discriminante))

%% Determinar error aproximado porcentual
%% e_a = abs((x_3 - x_2) / x_3) * 100
  e_a = abs((x_3 - x_2) / x_3) * 100

%% Se corren los valores con el objetivo de tomar en consideración
%% la nueva aproximación x_3
  x_0 = x_1
  x_1 = x_2
  x_2 = x_3
